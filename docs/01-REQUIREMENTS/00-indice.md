// @kind(index)
// @contract(in: documentación -> out: navegación estructurada)

# Índice — Levantamiento de Requisitos
...
| `07-ui-views.md` | Vistas por app y rol |
| `08-nfr.md` | Requisitos no funcionales (seguridad, rendimiento, escalabilidad) |
| `09-theme-duoc.md` | Tokens de diseño y colores Duoc UC |
| `10-realtime-pattern.md` | Patrón de suscripción Realtime con Supabase |
